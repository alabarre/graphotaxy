...
# TODO docstring annotations everywhere
...
try:
    ...
    print(
        fill(
            "Warning: htmlmin not found. I can work without it so you can safely ignore this "
            "warning, but consider installing it to decrease the size of the files I will "
            "download.",
            width=80,
        )
    )
...
# ----- My imports --------------------------------------------------------------------------------
from isgci.vars import ISGCI_DIR, PATHS, OPEN
