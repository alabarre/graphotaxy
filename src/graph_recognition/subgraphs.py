...
class SubgraphMatcher:
    ...
    def find_induced(self, smallgraph_name: str) -> bool:
        ...
        p_n = _query_pattern_property(pattern, number_of_nodes)
        g_m = number_of_edges(self._graph)
        p_m = _query_pattern_property(pattern, number_of_edges)
        ...
        pattern_ds = _query_pattern_property(pattern, degree_sequence)
        ...
        pattern_cods = _query_pattern_property(pattern, codegree_sequence)
