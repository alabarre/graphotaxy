...
from graph_recognition.profitable_hereditary_n import is_planar, is_line
...
def is_perfect_and_planar(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return is_planar(graph) and nx.is_perfect_graph(graph)  # noqa (pycharm can't find is_perfect_graph)
...
def is_perfect_and_split_neighbourhood(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_split_neighbourhood(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_c4_free_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_c4_free(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_k4_free_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_k4_free(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_bull_free_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_bull_free(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_claw_free_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_claw_free(graph)
            and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_line_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_line(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_line_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return nx.is_perfect_graph(nx.line_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
...
def is_paw_free_and_perfect(graph: nx.Graph) -> bool:
    ...
    :return:
    """
    return (is_paw_free(graph) and nx.is_perfect_graph(graph))  # noqa (pycharm can't find is_perfect_graph)
