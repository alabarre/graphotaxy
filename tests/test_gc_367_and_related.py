...
class Test_gc_367_and_related(unittest.TestCase):
    """Tests class gc_367 and related classes using the dataset identified by
    (C4,C5)-free=gc_367."""
    ...
    def test_gc_490(self) -> None:
        """Tests positive instances for class gc_490. gc_490 is an ancestor of gc_367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2104(self) -> None:
        """Tests positive instances for class AUTO_2104. AUTO_2104 is an ancestor of gc_367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_361(self) -> None:
        """Tests positive instances for class gc_361. gc_361 is an ancestor of gc_367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1364(self) -> None:
        """Tests positive instances for class gc_1364. gc_1364 is an ancestor of gc_367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
