...
class Test_gc_218_and_related(unittest.TestCase):
    """Tests class gc_218 and related classes using the dataset identified by murky=gc_218."""
    ...
    def test_gc_623(self) -> None:
        """Tests positive instances for class gc_623. gc_623 is an ancestor of gc_218."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_490(self) -> None:
        """Tests positive instances for class gc_490. gc_490 is an ancestor of gc_218."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_41(self) -> None:
        """Tests positive instances for class AUTO_41. AUTO_41 is an ancestor of gc_218."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
