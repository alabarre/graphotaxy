...
suite for recognizers that identify gc_784 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_784;
    - a positive test for each recognizable ancestor of gc_784;
    - a negative test for each class excluded by gc_784;
    - and a negative test for each descendant of each class excluded by gc_784.
...
class Test_gc_784_and_related(unittest.TestCase):
    """Tests class gc_784 and related classes using the dataset identified by caterpillar=gc_784."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_784_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/caterpillar=gc_784"
        print(
        ...
        print("done.")
        # Generated test for base class gc_784:

    def test_gc_784(self) -> None:
        """Tests positive instances for class gc_784."""
        print(
    ...
    def test_gc_917(self) -> None:
        """Tests positive instances for class gc_917. gc_917 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_774(self) -> None:
        """Tests positive instances for class gc_774. gc_774 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1231(self) -> None:
        """Tests positive instances for class gc_1231. gc_1231 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_222(self) -> None:
        """Tests positive instances for class gc_222. gc_222 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_575(self) -> None:
        """Tests positive instances for class gc_575. gc_575 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1352(self) -> None:
        """Tests positive instances for class gc_1352. gc_1352 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_35(self) -> None:
        """Tests positive instances for class gc_35. gc_35 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_43(self) -> None:
        """Tests positive instances for class gc_43. gc_43 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1169(self) -> None:
        """Tests positive instances for class gc_1169. gc_1169 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_361(self) -> None:
        """Tests positive instances for class gc_361. gc_361 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_248(self) -> None:
        """Tests positive instances for class gc_248. gc_248 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_401(self) -> None:
        """Tests positive instances for class gc_401. gc_401 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_859(self) -> None:
        """Tests positive instances for class gc_859. gc_859 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1470(self) -> None:
        """Tests positive instances for class AUTO_1470. AUTO_1470 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1262(self) -> None:
        """Tests positive instances for class gc_1262. gc_1262 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_976(self) -> None:
        """Tests positive instances for class gc_976. gc_976 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1254(self) -> None:
        """Tests positive instances for class gc_1254. gc_1254 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_603(self) -> None:
        """Tests positive instances for class gc_603. gc_603 is an ancestor of gc_784."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
