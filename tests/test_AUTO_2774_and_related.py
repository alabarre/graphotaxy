...
class Test_AUTO_2774_and_related(unittest.TestCase):
    """Tests class AUTO_2774 and related classes using the dataset identified by co-
    block=AUTO_2774."""
    ...
    def test_AUTO_1789(self) -> None:
        """Tests positive instances for class AUTO_1789. AUTO_1789 is an ancestor of AUTO_2774."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
