...
class Test_AUTO_2774_and_related(unittest.TestCase):
    ...
    def test_gc_541(self) -> None:
        """Tests positive instances for class gc_541. gc_541 is an ancestor of AUTO_2774."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_145(self) -> None:
        """Tests positive instances for class gc_145. gc_145 is an ancestor of AUTO_2774."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
