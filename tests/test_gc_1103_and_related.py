...
suite for recognizers that identify gc_1103 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1103;
    - a positive test for each recognizable ancestor of gc_1103;
    - a negative test for each class excluded by gc_1103;
    - and a negative test for each descendant of each class excluded by gc_1103.
...
class Test_gc_1103_and_related(unittest.TestCase):
    """Tests class gc_1103 and related classes using the dataset identified by 4-regular-and-
    planar=gc_1103."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1103_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/4-regular-and-planar=gc_1103"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1103:

    def test_gc_1103(self) -> None:
        """Tests positive instances for class gc_1103."""
        print(
    ...
    def test_gc_43(self) -> None:
        """Tests positive instances for class gc_43. gc_43 is an ancestor of gc_1103."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1090(self) -> None:
        """Tests positive instances for class gc_1090. gc_1090 is an ancestor of gc_1103."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1101(self) -> None:
        """Tests positive instances for class gc_1101. gc_1101 is an ancestor of gc_1103."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
