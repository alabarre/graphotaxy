...
class Test_gc_198_and_related(unittest.TestCase):
    """Tests class gc_198 and related classes using the dataset identified by halin=gc_198."""
    ...
    def test_gc_771(self) -> None:
        """Tests positive instances for class gc_771. gc_771 is an ancestor of gc_198."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1181(self) -> None:
        """Tests positive instances for class gc_1181. gc_1181 is an ancestor of gc_198."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
