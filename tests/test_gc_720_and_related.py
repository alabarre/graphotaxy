...
suite for recognizers that identify gc_720 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_720;
    - a positive test for each recognizable ancestor of gc_720;
    - a negative test for each class excluded by gc_720;
    - and a negative test for each descendant of each class excluded by gc_720.
...
class Test_gc_720_and_related(unittest.TestCase):
    """Tests class gc_720 and related classes using the dataset identified by maximum degree
    3=gc_720."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_720_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/maximum degree 3=gc_720"
        print(
        ...
        print("done.")
        # Generated test for base class gc_720:

    def test_gc_720(self) -> None:
        """Tests positive instances for class gc_720."""
        print(
    ...
    def test_AUTO_1820(self) -> None:
        """Tests positive instances for class AUTO_1820. AUTO_1820 is an ancestor of gc_720."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_714(self) -> None:
        """Tests positive instances for class gc_714. gc_714 is an ancestor of gc_720."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_749(self) -> None:
        """Tests positive instances for class gc_749. gc_749 is an ancestor of gc_720."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1119(self) -> None:
        """Tests positive instances for class gc_1119. gc_1119 is an ancestor of gc_720."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
