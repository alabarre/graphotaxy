...
suite for recognizers that identify gc_1362 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1362;
    - a positive test for each recognizable ancestor of gc_1362;
    - a negative test for each class excluded by gc_1362;
    - and a negative test for each descendant of each class excluded by gc_1362.
...
class Test_gc_1362_and_related(unittest.TestCase):
    """Tests class gc_1362 and related classes using the dataset identified by 2-edge-
    connected=gc_1362."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1362_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/2-edge-connected=gc_1362"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1362:

    def test_gc_1362(self) -> None:
        """Tests positive instances for class gc_1362."""
        print(
