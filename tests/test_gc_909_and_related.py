...
suite for recognizers that identify gc_909 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_909;
    - a positive test for each recognizable ancestor of gc_909;
    - a negative test for each class excluded by gc_909;
    - and a negative test for each descendant of each class excluded by gc_909.
...
Check https://www.graphclasses.org/classes/gc_909 for more information.
"""
...
class Test_gc_909_and_related(unittest.TestCase):
    """Tests class gc_909 and related classes using the dataset identified by planar-of-maximum-
    degree-4=gc_909."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_909_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/planar-of-maximum-degree-4=gc_909"
        print(
        ...
        print("done.")
        # Generated test for base class gc_909:

    def test_gc_909(self) -> None:
        """Tests positive instances for class gc_909."""
        print(
    ...
    def test_gc_43(self) -> None:
        """Tests positive instances for class gc_43. gc_43 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_329(self) -> None:
        """Tests positive instances for class AUTO_329. AUTO_329 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1344(self) -> None:
        """Tests positive instances for class gc_1344. gc_1344 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_717(self) -> None:
        """Tests positive instances for class gc_717. gc_717 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1090(self) -> None:
        """Tests positive instances for class gc_1090. gc_1090 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1343(self) -> None:
        """Tests positive instances for class gc_1343. gc_1343 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1181(self) -> None:
        """Tests positive instances for class gc_1181. gc_1181 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1119(self) -> None:
        """Tests positive instances for class gc_1119. gc_1119 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1139(self) -> None:
        """Tests positive instances for class gc_1139. gc_1139 is an ancestor of gc_909."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
