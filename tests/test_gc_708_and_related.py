...
class Test_gc_708_and_related(unittest.TestCase):
    ...
    def test_gc_180(self) -> None:
        """Tests positive instances for class gc_180. gc_180 is an ancestor of gc_708."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_250(self) -> None:
        """Tests positive instances for class gc_250. gc_250 is an ancestor of gc_708."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_713(self) -> None:
        """Tests positive instances for class gc_713. gc_713 is an ancestor of gc_708."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
