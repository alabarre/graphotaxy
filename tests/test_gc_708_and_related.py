...
class Test_gc_708_and_related(unittest.TestCase):
    """Tests class gc_708 and related classes using the dataset identified by line graphs of
    triangle-free graphs=gc_708."""
    ...
    def test_gc_749(self) -> None:
        """Tests positive instances for class gc_749. gc_749 is an ancestor of gc_708."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_708."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
