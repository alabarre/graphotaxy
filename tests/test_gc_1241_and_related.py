...
class Test_gc_1241_and_related(unittest.TestCase):
    ...
    def test_AUTO_3653(self) -> None:
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.fisc_based_recognizers.is_co_c4_c6_c8_k1_4_free_and_bipartite(
                    graph
                ),
                "failed on graph number "
                + str(num)
    ...
    def test_AUTO_2091(self) -> None:
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.fisc_based_recognizers.is_auto_2091(graph),
                "failed on graph number "
                + str(num)
                + " / "
                + str(len(self.positive))
    ...
    def test_AUTO_2471(self) -> None:
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.fisc_based_recognizers.is_auto_2471(graph),
                "failed on graph number "
                + str(num)
                + " / "
                + str(len(self.positive))
    ...
    def test_AUTO_2144(self) -> None:
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.fisc_based_recognizers.is_co_probe_bipartite_chain(
                    graph
                ),
                "failed on graph number "
                + str(num)
    ...
    def test_AUTO_2101(self) -> None:
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.fisc_based_recognizers.is_co_t3_co_x_81_co_cycle_free(
                    graph
                ),
                "failed on graph number "
                + str(num)
