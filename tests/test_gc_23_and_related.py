...
suite for recognizers that identify gc_23 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_23;
    - a positive test for each recognizable ancestor of gc_23;
    - a negative test for each class excluded by gc_23;
    - and a negative test for each descendant of each class excluded by gc_23.
...
class Test_gc_23_and_related(unittest.TestCase):
    """Tests class gc_23 and related classes using the dataset identified by permutation=gc_23."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_23_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # Generated test for base class gc_23:

    def test_gc_23(self) -> None:
        """Tests positive instances for class gc_23."""
        print(
    ...
    def test_gc_1258(self) -> None:
        """Tests positive instances for class gc_1258. gc_1258 is an ancestor of gc_23."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_630(self) -> None:
        """Tests positive instances for class gc_630. gc_630 is an ancestor of gc_23."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
