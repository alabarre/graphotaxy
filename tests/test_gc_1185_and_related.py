...
suite for recognizers that identify gc_1185 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1185;
    - a positive test for each recognizable ancestor of gc_1185;
    - a negative test for each class excluded by gc_1185;
    - and a negative test for each descendant of each class excluded by gc_1185.
...
class Test_gc_1185_and_related(unittest.TestCase):
    """Tests class gc_1185 and related classes using the dataset identified by
    strongly_regular=gc_1185."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1185_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # Generated test for base class gc_1185:
