...
class Test_gc_1358_and_related(unittest.TestCase):
    ...
    def setUpClass(self) -> None:
        ...
        super(Test_gc_1358_and_related, self).setUpClass()
        self.positive = []
    ...
    # Generated test for base class gc_1358:
    def test_gc_1358(self) -> None:
        """Tests positive instances for class gc_1358."""
        print(
