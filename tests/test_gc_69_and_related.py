...
class Test_gc_69_and_related(unittest.TestCase):
    """Tests class gc_69 and related classes using the dataset identified by bipartite=gc_69."""
    ...
    def test_gc_843(self) -> None:
        """Tests positive instances for class gc_843. gc_843 is an ancestor of gc_69."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_937(self) -> None:
        """Tests positive instances for class gc_937. gc_937 is an ancestor of gc_69."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_454(self) -> None:
        """Tests positive instances for class gc_454. gc_454 is an ancestor of gc_69."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
