...
suite for recognizers that identify gc_1139 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1139;
    - a positive test for each recognizable ancestor of gc_1139;
    - a negative test for each class excluded by gc_1139;
    - and a negative test for each descendant of each class excluded by gc_1139.
...
Check https://www.graphclasses.org/classes/gc_1139 for more information.
"""
...
class Test_gc_1139_and_related(unittest.TestCase):
    """Tests class gc_1139 and related classes using the dataset identified by maximum degree
    5=gc_1139."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1139_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/maximum degree 5=gc_1139"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1139:

    def test_gc_1139(self) -> None:
        """Tests positive instances for class gc_1139."""
        print(
    ...
    def test_gc_1090(self) -> None:
        """Tests positive instances for class gc_1090. gc_1090 is an ancestor of gc_1139."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1119(self) -> None:
        """Tests positive instances for class gc_1119. gc_1119 is an ancestor of gc_1139."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
