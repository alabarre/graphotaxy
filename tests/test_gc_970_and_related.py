...
suite for recognizers that identify gc_970 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_970;
    - a positive test for each recognizable ancestor of gc_970;
    - a negative test for each class excluded by gc_970;
    - and a negative test for each descendant of each class excluded by gc_970.
...
class Test_gc_970_and_related(unittest.TestCase):
    """Tests class gc_970 and related classes using the dataset identified by co-line=gc_970."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_970_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/co-line=gc_970"
        print(
        ...
        print("done.")
        # Generated test for base class gc_970:

    def test_gc_970(self) -> None:
        """Tests positive instances for class gc_970."""
        print(
    ...
    def test_gc_930(self) -> None:
        """Tests positive instances for class gc_930. gc_930 is an ancestor of gc_970."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_640(self) -> None:
        """Tests positive instances for class gc_640. gc_640 is an ancestor of gc_970."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2141(self) -> None:
        """Tests positive instances for class AUTO_2141. AUTO_2141 is an ancestor of gc_970."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_970."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
