...
suite for recognizers that identify gc_1367 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1367;
    - a positive test for each recognizable ancestor of gc_1367;
    - a negative test for each class excluded by gc_1367;
    - and a negative test for each descendant of each class excluded by gc_1367.
...
Check https://www.graphclasses.org/classes/gc_1367 for more information.
"""
...
class Test_gc_1367_and_related(unittest.TestCase):
    """Tests class gc_1367 and related classes using the dataset identified by K4-free-and-
    planar=gc_1367."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1367_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/K4-free-and-planar=gc_1367"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1367:

    def test_gc_1367(self) -> None:
        """Tests positive instances for class gc_1367."""
        print(
    ...
    def test_gc_455(self) -> None:
        """Tests positive instances for class gc_455. gc_455 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_43(self) -> None:
        """Tests positive instances for class gc_43. gc_43 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_329(self) -> None:
        """Tests positive instances for class AUTO_329. AUTO_329 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1344(self) -> None:
        """Tests positive instances for class gc_1344. gc_1344 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2096(self) -> None:
        """Tests positive instances for class AUTO_2096. AUTO_2096 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1343(self) -> None:
        """Tests positive instances for class gc_1343. gc_1343 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_224(self) -> None:
        """Tests positive instances for class AUTO_224. AUTO_224 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2097(self) -> None:
        """Tests positive instances for class AUTO_2097. AUTO_2097 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1181(self) -> None:
        """Tests positive instances for class gc_1181. gc_1181 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_673(self) -> None:
        """Tests positive instances for class gc_673. gc_673 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_1367."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
