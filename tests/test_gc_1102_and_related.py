...
suite for recognizers that identify gc_1102 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1102;
    - a positive test for each recognizable ancestor of gc_1102;
    - a negative test for each class excluded by gc_1102;
    - and a negative test for each descendant of each class excluded by gc_1102.
...
Check https://www.graphclasses.org/classes/gc_1102 for more information.
"""
...
class Test_gc_1102_and_related(unittest.TestCase):
    """Tests class gc_1102 and related classes using the dataset identified by cubic-and-
    planar=gc_1102."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1102_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/cubic-and-planar=gc_1102"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1102:

    def test_gc_1102(self) -> None:
        """Tests positive instances for class gc_1102."""
        print(
    ...
    def test_gc_354(self) -> None:
        """Tests positive instances for class gc_354. gc_354 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_909(self) -> None:
        """Tests positive instances for class gc_909. gc_909 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_720(self) -> None:
        """Tests positive instances for class gc_720. gc_720 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1820(self) -> None:
        """Tests positive instances for class AUTO_1820. AUTO_1820 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_714(self) -> None:
        """Tests positive instances for class gc_714. gc_714 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_749(self) -> None:
        """Tests positive instances for class gc_749. gc_749 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_625(self) -> None:
        """Tests positive instances for class gc_625. gc_625 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1254(self) -> None:
        """Tests positive instances for class gc_1254. gc_1254 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_376(self) -> None:
        """Tests positive instances for class gc_376. gc_376 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_43(self) -> None:
        """Tests positive instances for class gc_43. gc_43 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_329(self) -> None:
        """Tests positive instances for class AUTO_329. AUTO_329 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_609(self) -> None:
        """Tests positive instances for class gc_609. gc_609 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_412(self) -> None:
        """Tests positive instances for class gc_412. gc_412 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1344(self) -> None:
        """Tests positive instances for class gc_1344. gc_1344 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_700(self) -> None:
        """Tests positive instances for class gc_700. gc_700 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_717(self) -> None:
        """Tests positive instances for class gc_717. gc_717 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_388(self) -> None:
        """Tests positive instances for class gc_388. gc_388 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_748(self) -> None:
        """Tests positive instances for class gc_748. gc_748 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1090(self) -> None:
        """Tests positive instances for class gc_1090. gc_1090 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_608(self) -> None:
        """Tests positive instances for class gc_608. gc_608 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1100(self) -> None:
        """Tests positive instances for class gc_1100. gc_1100 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2096(self) -> None:
        """Tests positive instances for class AUTO_2096. AUTO_2096 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1343(self) -> None:
        """Tests positive instances for class gc_1343. gc_1343 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_224(self) -> None:
        """Tests positive instances for class AUTO_224. AUTO_224 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2097(self) -> None:
        """Tests positive instances for class AUTO_2097. AUTO_2097 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2110(self) -> None:
        """Tests positive instances for class AUTO_2110. AUTO_2110 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1181(self) -> None:
        """Tests positive instances for class gc_1181. gc_1181 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_202(self) -> None:
        """Tests positive instances for class AUTO_202. AUTO_202 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_497(self) -> None:
        """Tests positive instances for class AUTO_497. AUTO_497 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1119(self) -> None:
        """Tests positive instances for class gc_1119. gc_1119 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1139(self) -> None:
        """Tests positive instances for class gc_1139. gc_1139 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_54(self) -> None:
        """Tests positive instances for class gc_54. gc_54 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_41(self) -> None:
        """Tests positive instances for class AUTO_41. AUTO_41 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_871(self) -> None:
        """Tests positive instances for class gc_871. gc_871 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_1102."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
