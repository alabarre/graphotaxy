...
class Test_gc_56_and_related(unittest.TestCase):
    """Tests class gc_56 and related classes using the dataset identified by perfect=gc_56."""
    ...
    def setUpClass(self) -> None:
        ...
        print("done.")
        # Generated test for base class gc_56:

    def test_gc_56(self) -> None:
        """Tests positive instances for class gc_56."""
        print(
    ...
    def test_gc_490(self) -> None:
        """Tests positive instances for class gc_490. gc_490 is an ancestor of gc_56."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1789(self) -> None:
        """Tests positive instances for class AUTO_1789. AUTO_1789 is an ancestor of gc_56."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
