...
suite for recognizers that identify gc_455 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_455;
    - a positive test for each recognizable ancestor of gc_455;
    - a negative test for each class excluded by gc_455;
    - and a negative test for each descendant of each class excluded by gc_455.
...
class Test_gc_455_and_related(unittest.TestCase):
    """Tests class gc_455 and related classes using the dataset identified by K4-free=gc_455."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_455_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # Generated test for base class gc_455:
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_455."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
