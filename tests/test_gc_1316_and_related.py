...
class Test_gc_1316_and_related(unittest.TestCase):
    """Tests class gc_1316 and related classes using the dataset identified by cubic-and-
    hamiltonian=gc_1316."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1316_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # No test was generated for base class gc_1316: no recognizer was found.
    ...
    def test_gc_714(self) -> None:
        """Tests positive instances for class gc_714. gc_714 is an ancestor of gc_1316."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_749(self) -> None:
        """Tests positive instances for class gc_749. gc_749 is an ancestor of gc_1316."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_608(self) -> None:
        """Tests positive instances for class gc_608. gc_608 is an ancestor of gc_1316."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_1316."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
