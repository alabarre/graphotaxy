...
suite for recognizers that identify gc_371 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_371;
    - a positive test for each recognizable ancestor of gc_371;
    - a negative test for each class excluded by gc_371;
    - and a negative test for each descendant of each class excluded by gc_371.
...
class Test_gc_371_and_related(unittest.TestCase):
    """Tests class gc_371 and related classes using the dataset identified by triangle-
    free=gc_371."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_371_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # Generated test for base class gc_371:
    ...
    def test_gc_749(self) -> None:
        """Tests positive instances for class gc_749. gc_749 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1262(self) -> None:
        """Tests positive instances for class gc_1262. gc_1262 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1265(self) -> None:
        """Tests positive instances for class gc_1265. gc_1265 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_608(self) -> None:
        """Tests positive instances for class gc_608. gc_608 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1360(self) -> None:
        """Tests positive instances for class gc_1360. gc_1360 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_630(self) -> None:
        """Tests positive instances for class gc_630. gc_630 is an ancestor of gc_371."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
