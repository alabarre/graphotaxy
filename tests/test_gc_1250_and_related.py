...
suite for recognizers that identify gc_1250 and a number of related classes. Specifically, **if**
the required recognizers are available, the test suite should contain:

    - a positive test for gc_1250;
    - a positive test for each recognizable ancestor of gc_1250;
    - a negative test for each class excluded by gc_1250;
    - and a negative test for each descendant of each class excluded by gc_1250.
...
Check https://www.graphclasses.org/classes/gc_1250 for more information.
"""
...
class Test_gc_1250_and_related(unittest.TestCase):
    """Tests class gc_1250 and related classes using the dataset identified by C4-free-and-
    perfect=gc_1250."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_1250_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/C4-free-and-perfect=gc_1250"
        print(
        ...
        print("done.")
        # Generated test for base class gc_1250:

    def test_gc_1250(self) -> None:
        """Tests positive instances for class gc_1250."""
        print(
    ...
    def test_gc_356(self) -> None:
        """Tests positive instances for class gc_356. gc_356 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_814(self) -> None:
        """Tests positive instances for class gc_814. gc_814 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1473(self) -> None:
        """Tests positive instances for class AUTO_1473. AUTO_1473 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_362(self) -> None:
        """Tests positive instances for class gc_362. gc_362 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1820(self) -> None:
        """Tests positive instances for class AUTO_1820. AUTO_1820 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_977(self) -> None:
        """Tests positive instances for class gc_977. gc_977 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_407(self) -> None:
        """Tests positive instances for class AUTO_407. AUTO_407 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_274(self) -> None:
        """Tests positive instances for class gc_274. gc_274 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_490(self) -> None:
        """Tests positive instances for class gc_490. gc_490 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_630(self) -> None:
        """Tests positive instances for class gc_630. gc_630 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_360(self) -> None:
        """Tests positive instances for class gc_360. gc_360 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_367(self) -> None:
        """Tests positive instances for class gc_367. gc_367 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_329(self) -> None:
        """Tests positive instances for class AUTO_329. AUTO_329 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_92(self) -> None:
        """Tests positive instances for class AUTO_92. AUTO_92 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_590(self) -> None:
        """Tests positive instances for class gc_590. gc_590 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1789(self) -> None:
        """Tests positive instances for class AUTO_1789. AUTO_1789 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2104(self) -> None:
        """Tests positive instances for class AUTO_2104. AUTO_2104 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_361(self) -> None:
        """Tests positive instances for class gc_361. gc_361 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_592(self) -> None:
        """Tests positive instances for class gc_592. gc_592 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1364(self) -> None:
        """Tests positive instances for class gc_1364. gc_1364 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2096(self) -> None:
        """Tests positive instances for class AUTO_2096. AUTO_2096 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_224(self) -> None:
        """Tests positive instances for class AUTO_224. AUTO_224 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2110(self) -> None:
        """Tests positive instances for class AUTO_2110. AUTO_2110 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2097(self) -> None:
        """Tests positive instances for class AUTO_2097. AUTO_2097 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_588(self) -> None:
        """Tests positive instances for class gc_588. gc_588 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_202(self) -> None:
        """Tests positive instances for class AUTO_202. AUTO_202 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_497(self) -> None:
        """Tests positive instances for class AUTO_497. AUTO_497 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_41(self) -> None:
        """Tests positive instances for class AUTO_41. AUTO_41 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1258(self) -> None:
        """Tests positive instances for class gc_1258. gc_1258 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_623(self) -> None:
        """Tests positive instances for class gc_623. gc_623 is an ancestor of gc_1250."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
