...
class Test_gc_198_and_ancestors(unittest.TestCase):
    ...
    def setUpClass(self) -> None:
        ...
        super(Test_gc_198_and_ancestors, self).setUpClass()
        self.positive = []
    ...
    # No recognizer was found for class gc_198 or any equivalent class, so no
