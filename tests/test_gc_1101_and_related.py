...
class Test_gc_1101_and_related(unittest.TestCase):
    ...
    def test_AUTO_329(self) -> None:
        """Tests positive instances for class AUTO_329. AUTO_329 is an ancestor of gc_1101."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1139(self) -> None:
        """Tests positive instances for class gc_1139. gc_1139 is an ancestor of gc_1101."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
