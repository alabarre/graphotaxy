...
suite for recognizers that identify gc_515 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_515;
    - a positive test for each recognizable ancestor of gc_515;
    - a negative test for each class excluded by gc_515;
    - and a negative test for each descendant of each class excluded by gc_515.
...
class Test_gc_515_and_related(unittest.TestCase):
    """Tests class gc_515 and related classes using the dataset identified by
    (4K_{1},K_{4})-free=gc_515."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_515_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/(4K_{1},K_{4})-free=gc_515"
        print(
        ...
        print("done.")
        # Generated test for base class gc_515:

    def test_gc_515(self) -> None:
        """Tests positive instances for class gc_515."""
        print(
        ...
        for num, graph in enumerate(self.positive):
            self.assertTrue(
                graph_recognition.profitable_hereditary_n_4.is_gc_515(graph),
    ...
    def test_gc_388(self) -> None:
        """Tests positive instances for class gc_388. gc_388 is an ancestor of gc_515."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_224(self) -> None:
        """Tests positive instances for class AUTO_224. AUTO_224 is an ancestor of gc_515."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2097(self) -> None:
        """Tests positive instances for class AUTO_2097. AUTO_2097 is an ancestor of gc_515."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_136(self) -> None:
        """Tests positive instances for class AUTO_136. AUTO_136 is an ancestor of gc_515."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_2123(self) -> None:
        """Tests positive instances for class AUTO_2123. AUTO_2123 is an ancestor of gc_515."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
