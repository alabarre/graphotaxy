...
suite for recognizers that identify gc_32 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_32;
    - a positive test for each recognizable ancestor of gc_32;
    - a negative test for each class excluded by gc_32;
    - and a negative test for each descendant of each class excluded by gc_32.
...
class Test_gc_32_and_related(unittest.TestCase):
    """Tests class gc_32 and related classes using the dataset identified by chordal=gc_32."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_32_and_related, self).setUpClass()
        self.positive = []
        ...
        print("done.")
        # Generated test for base class gc_32:

    def test_gc_32(self) -> None:
    ...
    def test_gc_977(self) -> None:
        """Tests positive instances for class gc_977. gc_977 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_274(self) -> None:
        """Tests positive instances for class gc_274. gc_274 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_976(self) -> None:
        """Tests positive instances for class gc_976. gc_976 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_AUTO_1789(self) -> None:
        """Tests positive instances for class AUTO_1789. AUTO_1789 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_610(self) -> None:
        """Tests positive instances for class gc_610. gc_610 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_49(self) -> None:
        """Tests positive instances for class gc_49. gc_49 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1364(self) -> None:
        """Tests positive instances for class gc_1364. gc_1364 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_547(self) -> None:
        """Tests positive instances for class gc_547. gc_547 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_222(self) -> None:
        """Tests positive instances for class gc_222. gc_222 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_608(self) -> None:
        """Tests positive instances for class gc_608. gc_608 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1250(self) -> None:
        """Tests positive instances for class gc_1250. gc_1250 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_626(self) -> None:
        """Tests positive instances for class gc_626. gc_626 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1258(self) -> None:
        """Tests positive instances for class gc_1258. gc_1258 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_623(self) -> None:
        """Tests positive instances for class gc_623. gc_623 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_356(self) -> None:
        """Tests positive instances for class gc_356. gc_356 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_14(self) -> None:
        """Tests positive instances for class gc_14. gc_14 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_630(self) -> None:
        """Tests positive instances for class gc_630. gc_630 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_1387(self) -> None:
        """Tests positive instances for class gc_1387. gc_1387 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_10(self) -> None:
        """Tests positive instances for class gc_10. gc_10 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_706(self) -> None:
        """Tests positive instances for class gc_706. gc_706 is an ancestor of gc_32."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
