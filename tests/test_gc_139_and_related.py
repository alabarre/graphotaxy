...
suite for recognizers that identify gc_139 and a number of related classes. Specifically, **if** the
required recognizers are available, the test suite should contain:

    - a positive test for gc_139;
    - a positive test for each recognizable ancestor of gc_139;
    - a negative test for each class excluded by gc_139;
    - and a negative test for each descendant of each class excluded by gc_139.
...
class Test_gc_139_and_related(unittest.TestCase):
    """Tests class gc_139 and related classes using the dataset identified by claw-free-and-
    perfect=gc_139."""

    @classmethod
    def setUpClass(self) -> None:
        """Stores positive and negative instances to test."""
        super(Test_gc_139_and_related, self).setUpClass()
        self.positive = []
        basedir = "./tests/test_data/claw-free-and-perfect=gc_139"
        print(
        ...
        print("done.")
        # Generated test for base class gc_139:

    def test_gc_139(self) -> None:
        """Tests positive instances for class gc_139."""
        print(
    ...
    def test_gc_814(self) -> None:
        """Tests positive instances for class gc_814. gc_814 is an ancestor of gc_139."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
    ...
    def test_gc_362(self) -> None:
        """Tests positive instances for class gc_362. gc_362 is an ancestor of gc_139."""
        print(
            self._testMethodName.join("[]"),
            "testing",
            len(self.positive),
