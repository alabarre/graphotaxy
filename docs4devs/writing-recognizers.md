...
Below are several guidelines for writing efficient recognizers.
...
Since all recognizers are cached, it is recommended that you call other recognizers as part of your code rather than trying to rewrite some of their parts from scratch.
