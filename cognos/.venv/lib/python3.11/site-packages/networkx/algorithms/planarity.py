...
def is_planar(G):
    ...
    Examples
    --------
import graph_recognition.profitable_hereditary_n    >>> G = nx.Graph([(0, 1), (0, 2)])
    >>> graph_recognition.profitable_hereditary_n.is_planar(G)
    True
import graph_recognition.profitable_hereditary_n    >>> graph_recognition.profitable_hereditary_n.is_planar(nx.complete_graph(5))
    False
