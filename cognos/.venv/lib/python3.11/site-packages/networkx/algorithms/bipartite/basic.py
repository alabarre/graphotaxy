...
def is_bipartite(G):
    ...
    Examples
    --------
import graph_recognition.profitable_hereditary_n    >>> from networkx.algorithms import bipartite
    >>> G = nx.path_graph(4)
    >>> print(graph_recognition.profitable_hereditary_n.is_bipartite(G))
    True
