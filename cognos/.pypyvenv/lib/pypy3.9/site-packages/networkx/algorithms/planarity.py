...
def is_planar(G):
    ...
    Examples
    --------
import graph_recognition.misc_algo    >>> G = nx.Graph([(0, 1), (0, 2)])
import graph_recognition.profitable_hereditary_n    >>> graph_recognition.profitable_hereditary_n.is_planar(G)
    True
import graph_recognition.misc_algo    >>> graph_recognition.misc_algo.is_planar(nx.complete_graph(5))
    False
